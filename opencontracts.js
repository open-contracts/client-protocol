    ...
    opencontracts.parseContracts = async function (ocInterface, contractLocation) {
        ...
        this.getOPN = async function (amountString) {
            ...
            if (this.network == "ropsten") {
                ...
                const link = `https://app.uniswap.org/#/swap?inputCurrency=eth&outputCurrency=0xa2d9519A8692De6E47fb9aFCECd67737c288737F&chain=optimism&exactAmount=${amountString}&exactField=output`
                window.open(link)
            } else {
